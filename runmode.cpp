...
//    connect(connectButton, &QToolButton::clicked, this, &Runmode::sendframe);
    ...
    connect(returnButton, &QToolButton::clicked, this, &Runmode::returnDashboard);
...
void Runmode::addActionToMenu(QString menuItem, QString actionName)
{
